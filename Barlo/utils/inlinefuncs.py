...
from Barlo import pbot as app
from Barlo import arq
from Barlo.services.keyboard import Ikb
from Barlo.utils.pluginhelper import (
    convert_seconds_to_minutes as time_convert,
    fetch,
)
from Barlo.services.tasks import _get_tasks_text, all_tasks, rm_task
from Barlo.services.types import InlineQueryResultCachedDocument
from Barlo.modules.info import get_chat_info, get_user_info
from Barlo.modules.music import download_youtube_audio
from Barlo.utils.functions import test_speedtest
from Barlo.utils.pastebin import paste
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/37fee477b44cb8b06b7c6.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Barlo bot", url="https://t.me/SOoOURCE_bot"),
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/bar_lo0o0)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
...
async def music_inline_func(answers, query):
    chat_id = -1001556231041
    group_invite = "https://t.me/bar_lo0o"
    try:
        messages = [
            m
