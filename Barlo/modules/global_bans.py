...
import Barlo.modules.sql.global_bans_sql as sql
from Barlo.modules.sql.users_sql import get_user_com_chats
from Barlo import (
    DEV_USERS,
    EVENT_LOGS,
    OWNER_ID,
...
from Barlo.modules.helper_funcs.chat_status import (
    is_user_admin,
    support_plus,
    user_admin,
)
from Barlo.modules.helper_funcs.extraction import (
    extract_user,
    extract_user_and_text,
)
from Barlo.modules.helper_funcs.misc import send_to_list
...
This also integrates @URLS_USA API to remove Spammers as much as possible from your chatroom!
*What is SpamWatch?*
SpamWatch maintains a large constantly updated ban-list of spambots, trolls, bitcoin spammers and unsavoury characters[.](https://telegra.ph/file/3b8fdf42631e498846ff0.jpg)
...
*Note:* Users can appeal spamwatch bans at @bar_lo0o
"""
