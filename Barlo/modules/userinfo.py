...
from Barlo.__main__ import STATS, TOKEN, USER_INFO
from Barlo.modules.sql import SESSION
import Barlo.modules.sql.userinfo_sql as sql
from Barlo.modules.disable import DisableAbleCommandHandler
from Barlo.modules.sql.global_bans_sql import is_user_gbanned
from Barlo.modules.sql.afk_sql import is_afk, set_afk
from Barlo.modules.sql.users_sql import get_user_num_chats
from Barlo.modules.helper_funcs.chat_status import sudo_plus
from Barlo.modules.helper_funcs.extraction import extract_user
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        disaster_level_present = True
    elif user.id == 1001132193:
         text += "\n\nOwner Of A Bot. king Of @bar_lo0o0. Bot Name Inspired From 'Barlo'."
         disaster_level_present = True
            ...
            message.reply_document(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/bar_lo0o0o0o0o"),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/bar_lo0o0o0o0o")
                        ],
                    ]
                ),
                parse_mode=ParseMode.HTML,
...
def stats(update: Update, context: CallbackContext):
    stats = "❂ <b>Stats For <a href='https://t.me/SOoOURCE_bot'>Barlo</a>:</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
...
*What is that health thingy?*
 Come and see [Channel Update](https://t.me/bar_lo0o0o0o0o)
"""
