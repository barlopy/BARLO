...
import Barlo.modules.sql.notes_sql as sql
from Barlo import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from Barlo.__main__ import DATA_IMPORT
from Barlo.modules.helper_funcs.chat_status import user_admin
from Barlo.modules.helper_funcs.alternate import typing_action

# from Barlo.modules.rules import get_rules
import Barlo.modules.sql.rules_sql as rulessql

# from Barlo.modules.sql import warns_sql as warnssql
import Barlo.modules.sql.blacklist_sql as blacklistsql
from Barlo.modules.sql import disable_sql as disabledsql

# from Barlo.modules.sql import cust_filters_sql as filtersql
# import Barlo.modules.sql.welcome_sql as welcsql
import Barlo.modules.sql.locks_sql as locksql
from Barlo.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("Barlo{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Barlo{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Barlo-Backup` was specially made for notes.".format(
            chat.title,
            chat_id,
            tgl,
        ),
    ...
    os.remove("Barlo{}.backup".format(chat_id))  # Cleaning file
