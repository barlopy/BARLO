...
async def _(event):
    ...
    im1 = Image.open("Barlo/resources/Barlo.png")
    if ik.endswith(".tgs"):
        await tbot.download_media(reply, "Barlo.tgs")
        os.system("lottie_convert.py Barlo.tgs json.json")
        json = open("json.json", "r")
        jsn = json.read()
        jsn = jsn.replace("512", "2000")
        open = ("json.json", "w").write(jsn)
        os.system("lottie_convert.py json.json Barlo.tgs")
        file = "Barlo.tgs"
        os.remove("json.json")
